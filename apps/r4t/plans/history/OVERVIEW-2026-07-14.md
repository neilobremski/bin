...
spec: `plans/history/COMMS-SPEC.md`): the structured internal message protocol
...
`apps/a8s/` (the router). Key documents: `plans/history/COMMS-SPEC.md` (current
design round), `plans/history/SYNTHESIS.md` (the re-founding rationale),
